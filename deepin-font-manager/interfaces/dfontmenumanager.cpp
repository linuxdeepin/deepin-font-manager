...
void DFontMenuManager::initMenuData()
{
    ...
    m_fontToolsBarMenus.insert(MenuAction::M_AddFont, new FMenuItem("添加字体", MenuAction::M_AddFont));
    ...
    //Right key menu data
    m_fontRightKeyMenus.insert(MenuAction::M_AddFont, new FMenuItem("添加字体", MenuAction::M_AddFont));
    m_fontRightKeyMenus.insert(MenuAction::M_EnableOrDisable, new FMenuItem("启用字体", MenuAction::M_EnableOrDisable));
    m_fontRightKeyMenus.insert(MenuAction::M_DeleteFont, new FMenuItem("删除字体", MenuAction::M_DeleteFont));
    m_fontRightKeyMenus.insert(MenuAction::M_Faverator, new FMenuItem("收藏", MenuAction::M_Faverator));
    m_fontRightKeyMenus.insert(MenuAction::M_FontInfo, new FMenuItem("显示信息", MenuAction::M_FontInfo));
    m_fontRightKeyMenus.insert(MenuAction::M_ShowFontPostion, new FMenuItem("在文件管理器中显示", MenuAction::M_ShowFontPostion));
