...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到字體管理器 ![deepin_font_manager](../common/deepin_font_manager.svg)點擊執行。
...
- 在字體管理器介面點擊  ![close_icon](../common/close_icon.svg)，關閉字體管理器。
- 在任務欄右鍵單擊 ![deepin_font_manager](../common/deepin_font_manager.svg)，選擇 **全部關閉** 來關閉字體管理器。
- 在字體管理器介面點擊 ![icon_menu](../common/icon_menu.svg)，選擇 **離開** 來關閉字體管理器。

### 查看快捷鍵

在字體管理器介面上，按下鍵盤上的 **Ctrl + Shift + ?** 組合鍵來查看快捷鍵。
...
- 右鍵單擊字體檔案並選擇 **打開方式** > ![deepin_font_manager](../common/deepin_font_manager.svg)**字體管理器**，進入字體管理器介面，安裝字體。
- 雙擊字體檔案。
- 將字體檔案拖曳到字體管理器介面或圖示上。
...
>
> - 字體管理器會自動檢測您的字體，如果本機已經安裝過該字體，會顯示已安裝相同版本的提示訊息，此時可以選擇  **退出**  或 **繼續** 安裝操作。
> - 您可以打開 **控制中心** > **個性化** > **字體** 來設定 **標準字體**。
...
1. 在字體管理搜尋框中，點擊![search](../common/search.svg)。
2. 輸入關鍵字，即時展示搜尋結果。
3. 在搜尋框中點擊![0|close](../common/close_icon.svg)，或刪除搜尋框中輸入的訊息，即可清除目前輸入的搜尋條件或取消搜尋。
...
1. 在**使用者字體** 列表，取消已勾選的字體狀態，或右鍵單擊該字體，選擇 **禁用字體** 來禁用該字體。
...
1. 在字體管理器介面，點擊 ![icon_menu](../common/icon_menu.svg)。
2. 點擊 **主題**，選擇一個主題顏色。
